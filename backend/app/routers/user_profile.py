...
from app.infrastructure.storage.s3_assets import get_assets_bucket_name, presign_get_object, presign_put_object, to_s3_uri
from app.user_profile_team_sync import upsert_linked_team_member_from_user_profile
from app.repositories.user_profiles_repo import (
    get_user_profile,
