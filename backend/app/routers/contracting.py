...
from ..services.contracting_schemas import validate_key_terms
from ..services.contracting_docgen import generate_budget_xlsx as _generate_budget_xlsx
from ..services.contracting_docgen import render_contract_docx as _render_contract_docx
from ..services.esign_service import mark_signed as _esign_mark_signed
from ..services.esign_service import send_envelope as _esign_send
from ..services.contracting_jobs_repo import create_job as create_contracting_job
from ..services.contracting_jobs_repo import get_job as get_contracting_job
from ..services.contracting_jobs_repo import list_jobs_for_case
from ..services.contracting_queue import enqueue_contracting_job
from ..services.s3_assets import presign_get_object, presign_put_object
...
def presign_support_doc_upload(request: Request, caseId: str, body: dict = Body(default_factory=dict)):
    ...
    from ..services.contracting_repo import _new_id as _new  # keep repo API minimal
    ...
    try:
        ...
        try:
            ...
            if str(job.get("status") or "") == "queued":
                ...
                try:
                    from ..services.contracting_jobs_repo import complete_job
