...
def presign_version_upload(request: Request, templateId: str, body: dict = Body(default_factory=dict)):
    ...
    from ..repositories.contracting.contracting_repo import _new_id as _new  # local import to keep module API private
...
def preview_version(
    ...
    tpl_ver = None
    try:
        from ..repositories.contracting.contracting_repo import get_contract_template_version
