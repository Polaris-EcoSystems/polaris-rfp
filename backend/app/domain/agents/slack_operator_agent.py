...
from ...repositories.agent.events_repo import append_event, list_recent_events
...
def _slack_send_dm_tool(args: dict[str, Any]) -> dict[str, Any]:
    ...
    from ...infrastructure.integrations.slack.slack_web import open_dm_channel, chat_post_message_result, get_user_info, lookup_user_id_by_email
    from ...infrastructure.identity_service import resolve_from_slack
...
def _slack_file_to_drive_tool(args: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        from ...infrastructure.integrations.slack.slack_web import download_slack_file
        from ...infrastructure.integrations.drive.drive_file_router import route_slack_file_to_drive, extract_user_tags_from_message
        from ...tools.categories.google.google_drive import upload_file_to_drive
        from ...infrastructure.integrations.drive.drive_project_setup import ensure_channel_drive_folder, get_project_folders
        ...
        if not rfp_id and channel_id:
            try:
                from ...repositories.slack.channel_projects_repo import get_channel_project
                ...
                if name == _sa.ACTION_TOOL_NAME:
                    ...
                    try:
                        if rfp_id:
                            ...
                            from ...infrastructure.integrations.slack.slack_reply_tools import chat_post_message_result
                            chat_post_message_result(
                                text=str(ans.text or "").strip() or "Done.",
                                channel=ch,
                                blocks=ans.blocks,
