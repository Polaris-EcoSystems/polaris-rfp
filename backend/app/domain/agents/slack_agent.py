...
def run_slack_agent_question(
    *,
    ...
    from .context.agent_context_builder import (
        build_user_context,
        ...
        while True:
            ...
            for c in calls:
                ...
                try:
                    ...
                    from ..telemetry.agent_resilience import retry_with_classification
                    ...
                    import traceback
                    from ..telemetry.agent_resilience import classify_error
