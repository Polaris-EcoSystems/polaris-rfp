"""
Agent Registry - Catalog of agents, capabilities, and input/output schemas.
...
class RegisteredAgent:
    ...
    handler: Callable[[Any], Any] | None = None  # Function to call the agent
    version: str = "1.0.0"
...
class AgentRegistry:
    ...
    def _initialize_default_agents(self) -> None:
        ...
        try:
            from . import slack_agent
            from . import slack_operator_agent
