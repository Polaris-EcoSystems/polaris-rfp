    ...
    *,
    ...
    try:
        ...
        if use_autonomous_decision:
            from ..autonomous.agent_memory_autonomous import should_store_memory_autonomous
            from ..core.agent_memory import update_semantic_memory, add_procedural_memory as add_proc_memory
            from ..core.agent_memory_db import MemoryType, get_memory
                ...
                if is_update and update_memory_id:
                    ...
                    try:
                        ...
                        if not update_created_at:
                            from ..core.agent_memory_db import find_memory_by_id
