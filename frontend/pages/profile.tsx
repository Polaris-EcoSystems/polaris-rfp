...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <Layout>
        <Head>
          <title>Profile - RFP Proposal System</title>
        </Head>
  ...
  if (!profile) {
    return (
      <Layout>
        ...
        <div className="text-sm text-gray-600">Profile unavailable.</div>
      </Layout>
    )
  }
    ...
    <Layout>
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardFooter>
            <div className="text-xs text-gray-600">
              Tip: for optional attributes, setting the value to empty will
              delete the attribute in Cognito.
            </div>
          </CardFooter>
        </Card>
